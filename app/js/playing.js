...
async function play(trackURL, trackID, QUEUE) {
  return new Promise(async (resolve, reject) => {
    ...
    try {
      ...
      $("#erorrModalMsg").html(
        "There was an error requesting the song. It is likely geo-restricted."
      );
...
function playSong(song, backwards) {
  ...
  $("#playing_album_art").removeClass("invisible");
  $("#playing_album_art").removeClass("zoomOut");
  ...
  $("#audio_container").removeClass("invisible");
  $("#audio_container").removeClass("zoomOut");
